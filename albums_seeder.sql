...
('Bad Bunny', 'Un Verano Sin Ti', 2022, 3.4, 'Urban Latino'),
('Taylor Swift', 'Midnights', 2022, 3.29, 'Pop'),
('Morgan Wallen', 'Dangerous: The Double Album', 2022, 2.40, 'Country'),
('Harry Styles', 'Harrys House', 2022, 2.2, 'pop'),
('The Weeknd', 'The Highlights', 2022, 1.87, 'R&B'),
('Soundtrack', 'Encanto', 2022, 1.83, 'musical'),
('Future', 'I Never Liked You', 2022, 1.46, 'Hip-Hop'),
('Olivia Rodrigo', 'Sour', 2022, 1.43, 'Pop'),
('Lil Durk', '7220', 2022, 1.35, 'Hip-Hop'),
('Drake', 'Certified Lover Boy', 2022, 1.31, 'R&B');